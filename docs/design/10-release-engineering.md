...
**✓ 已实现**。Apache License 2.0、`CHANGELOG.md`、`CONTRIBUTING.md`、GitHub Actions CI（`.github/workflows/ci.yml`）、Maven wrapper、`helm-bom`、adapter 实现指南（`docs/guides/`）。仍待：正式发布到 Maven Central（首版本 `0.1.0`）。
